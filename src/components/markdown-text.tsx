...
// Deliberate render-time compare-and-swap (same pattern as
// useSyncExternalStore shims): reads and writes the same ref within one
// render pass, no cross-render side effect.
